...
If you want to host OFM standalone app via web browser using remote or vm ip you need to add ' hostname: "<remote or vm ip>" '. So, that you can access app by using this url - http://{VM-IP}:9000 
